...
processType : {auto c : Ref Ctxt Defs} ->
              ...
              RigCount -> Visibility -> List FnOpt -> ImpTy annot -> 
              Core annot ()
processType {vars} elab env nest rigc vis fnopts (MkImpTy loc n_in ty_raw)
    = do n <- inCurrentNS n_in
         ...
         addDef n (newRigDef rigc vars (abstractFullEnvType env ty) vis def)
